...
import com.thoughtworks.parkinglot.exceptions.NotParkedException;
...
public class ParkingLotTest {
    ...
    @Test
    void shouldUnPackACarWhenCarIsAlreadyParked() throws ParkingLotFullException, NotParkedException, AlreadyParkedException{
        ParkingLot parkingLot = new ParkingLot(2);
        Parkable car = new Car();
